/*
 * ch17/1_miscdrv_rdwr_atomicint/miscdrv_rdwr_atomicint.c
 ***************************************************************
 ...
 ****************************************************************
 * Brief Description:
 * This driver is built upon our previous ch16/2_miscdrv_rdwr_spinlock/
 * misc driver.
 * The key difference: we use atomic operators in place of the spinlock (this
 * isn't the case everywhere in the driver though; we keep the mutex as well
 * for some portions of the driver).
 *
...
MODULE_DESCRIPTION(
"LLKD book:ch17/1_miscdrv_rdwr_atomicint: simple misc char driver rewritten to use atomic operators");
