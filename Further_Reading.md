...
## Ch 9 : Synchronization Primitives and How to Use Them - Further Reading
...
- Linux Device Drivers
    ...
    -  *The kernel driver API manual*; one of the PDF documents generated by doing '`make pdfdocs`' within a recent Linux kernel source tree
