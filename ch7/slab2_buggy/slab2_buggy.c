 ...
 * evaluate to false; but, the kfree() is invoked, now on an invalid parameter
 * (it actually becomes a double-free bug)! On our test system, the entire
 * machine just froze. 
 *
...
MODULE_DESCRIPTION("LLKD book:ch4/slab1: k[m|z]alloc, kfree, basic demo");
...
#define BUGGY    0   // set to 0 to rm the bug(s)   :-)
