 ...
 ****************************************************************
 * Brief Description:
 * This kernel module is based upon our earlier kernel module from Ch 4:
 *  ch4/foreach/thrd_showall/thrd_showall.c. 
 * However, when we refactor it to use the get_task_comm() routine to
 ...
 * lockdep's output). Of course, we assume this is run on a kernel that
 * has lockdep enabled (CONFIG_PROVE_LOCKING).
 *
...
MODULE_DESCRIPTION("LKDC book: ch10/7_lockdep_eg/buggy_lockdep:"
